...
function Destination() {
  ...
  return (
    <div className="destinations">
      ...
      <div className="search-filters d-flex flex-row flex-wrap justify-content-center">
        <input
          id="search-bar"
          type="search"
          ...
          <div className="modal-dialog modal-dialog-scrollable">
            <div className="modal-content">
              <div className="modal-body">
                <img src={filteredDestinations[selectedDestination].img} style={{borderRadius: '15px'}} width={"100%"} alt={filteredDestinations[selectedDestination].name} />
                <h5 className="modal-title" id="exampleModalLabel">
                  {filteredDestinations[selectedDestination].name}
                </h5>
                <div className="rating">{'⭐'.repeat(filteredDestinations[selectedDestination].rating)}</div>
